...
app.post('/api/remove-bg', async (req, res) => {
  ...
  try {
    ...
    // Color distance function (Euclidean)
    ...
    // White/light backgrounds need lower tolerance, colored backgrounds need higher
    const bgBrightness = (bgColor.r + bgColor.g + bgColor.b) / 3;
    const baseTolerance = bgBrightness > 200 ? 35 : bgBrightness > 150 ? 50 : 65;
